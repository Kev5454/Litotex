...
if ($action == "send")
{
    ...
    $db->query("INSERT INTO cc" . $n . "_spions (starttime,userid,islandid,toislandid,spions,endtime) VALUES ('" . time() .
        "','$userdata[userid]','$userdata[islandid]','$row[islandid]','$spions','" . $an_time . "')");
