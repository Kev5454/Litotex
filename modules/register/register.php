...
if ($action == "submit")
{
    ...
    $db->query("INSERT INTO cc" . $n . "_users (username,email,password,register_date) VALUES ('$username','$email','$md5_pw','" .
        time() . "')");
    $userid_r = $db->insert_id();
    $db->query("INSERT INTO cc" . $n . "_countries (res1,res2,res3,res4,userid,lastressources,picid,x,y,size) VALUES ('$op_reg_res1','$op_reg_res2','$op_reg_res3','$op_reg_res4','$userid_r','" .
        time() . "','1','$x_pos','$y_pos','" . rand($op_min_c_size, $op_max_c_size) . "')");
