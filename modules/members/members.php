...
if ($action == "saveuserdata")
{
    ...
    $db->unbuffered_query("UPDATE cc" . $n . "_users SET design_id = '" . $design_id . "', umod  ='" . $umod1 . "',msn='" .
        $msn . "',icq='" . $icq . "',description='" . $description . "',email='" . $email . "', newsletter='" . $newsletter .
        "', grafik='" . $grafik . "' WHERE userid='" . $userdata['userid'] . "'");
...
if ($action == "profile")
{
    ...
    if ($row['lastactive'] > (time() - 3600)) $online = "<span class=\"green\">" . $profile_on . "</span>";
    else  $online = "<span class=\"red\">" . $profile_off . "</span>";
