...
function template_out( $template_name,$from_modulname )
{
    ...
    {
        $tpl->assign( 'LITO_NAVIGATION', "" );
        $tpl->assign( 'LITO_NAVIGATION_1',"" );
        $tpl->assign( 'LITO_NAVIGATION_2',"" );
    }
...
function generate_messagelink( $username,$show_icon = 0 )
{
    ...
    return "<div id=\"msglink\"><a href=\"$msg_modul_org?action=send&username=$username\">" . $icon_url . " Nachricht senden</a></div>";
}
